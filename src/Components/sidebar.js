...
function Sidebar(){
    ...
    return (
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" onClick={handleCollapseComponent} href="#" data-toggle="collapse" data-target="#collapseTwo"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" onClick={handleCollapseUtilities} data-toggle="collapse" data-target="#collapseUtilities"
            ...
            {/* <!-- Nav Item - Pages Collapse Menu --> */}
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" onClick={handleCollapsePages} data-toggle="collapse" data-target="#collapsePages"
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src={UnDrawRocket} alt="..."/>
